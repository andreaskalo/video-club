...
carousels.forEach((carousel) => {
  const carouselTrack = carousel.querySelector(".movie-carousel-track");

  const carouselViewport = carousel.querySelector(".movie-carousel-viewport");

  const previousButton = carousel.querySelector(".previous-movies-button");

  const nextButton = carousel.querySelector(".next-movies-button");

  const movieCards = carouselTrack.querySelectorAll(".movie-carousel-card");
  ...
  function getTotalPages() {
    ...
    return Math.ceil(movieCards.length / cardsPerPage);
  }
